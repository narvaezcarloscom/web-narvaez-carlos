...
export const showcaseSites: ShowcaseSite[] = [
  ...
  {
    id: "alpha-architect-roofing",
    name: "Alpha Architect Roofing",
    url: "https://alphaarchitectroofing.com/",
    industry: "Techos residenciales y comerciales",
    location: "Everett, WA",
    image: "/sitios/alpha-architect-roofing.webp",
  },
  {
    id: "ceja-paint",
    name: "Ceja Paint",
