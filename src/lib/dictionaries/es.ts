...
const es: Dictionary = {
  ...
  trust: {
    label: "Confianza, verificada",
    heading: ["Lo que dicen los clientes,", "validado por Google."],
    description:
      "Cada afirmación en este sitio está respaldada por evidencia independiente. Las reseñas a continuación son públicas en nuestro Perfil de Google Business — sin editar, sin solicitar, y vinculadas a personas reales.",
    metrics: {
      rating: "Calificación promedio",
      reviews: "Reseñas verificadas",
      sites: "Sitios entregados",
      founded: "Fundado",
    },
    sitesValue: "45+",
    foundedValue: "2022",
    attribution: "Reseñas verificadas de Google Business",
    viewOnGoogle: "Ver las 23 reseñas en Google",
    themesLabel: "Lo que los clientes mencionan más",
    reviewsHeading: "Reseñas seleccionadas",
    reviewsNote: "Las reseñas se muestran en su idioma original. Las fechas reflejan su publicación en Google.",
    readFull: "Leer la reseña completa en Google",
    truncatedNote: "Extracto — continúa en Google.",
    ctaHeading: ["¿Listo para", "el siguiente capítulo?"],
    ctaBody: "Si las palabras de nuestros clientes describen el tipo de alianza que buscas, conversemos.",
    ctaButton: "Iniciar un proyecto",
    signal: {
    ...
    home: {
      label: "Confianza, en cifras",
      heading: ["Lo que dicen los clientes,", "validado por Google."],
      body: "Cada afirmación en este sitio está respaldada por reseñas independientes en nuestro Perfil de Google Business — públicas, sin editar y vinculadas a personas reales.",
      cta: "Leer todas las reseñas verificadas",
    },
    related: {
      heading: "Lo que dicen los clientes",
      seeAll: "Ver las 23 reseñas verificadas",
    },
  },
  common: {
